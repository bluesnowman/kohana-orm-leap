...
namespace Leap\Plugins\DB\Firebird\Connection {
	 ...
	 * @access public
	 * @class
	 * @package Leap\Plugins\DB\Firebird\Connection
	 * @version 2014-04-22
	 *
		...
		public function open() {
			if ( ! $this->is_connected()) {
				...
				if ($this->resource === FALSE) {
					throw new \Leap\Core\Throwable\Database\Exception('Message: Failed to establish connection. Reason: :reason', array(':reason' => @ibase_errmsg()));
				}
			}
		}
