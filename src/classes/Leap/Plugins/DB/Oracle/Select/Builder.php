...
namespace Leap\Plugins\DB\Oracle\Select {
	 ...
	 * @access public
	 * @class
	 * @package Leap\Plugins\DB\Oracle\Select
	 * @version 2014-04-19
	 *
	...
	class Builder extends \Leap\Core\DB\SQL\Select\Builder {
		...
		public function combine($operator, $statement) {
			if (is_object($statement) AND ($statement instanceof \Leap\Plugins\DB\Oracle\Select\Builder)) {
